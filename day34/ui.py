...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.button_true = Button(image=true_image, highlightthickness=0, command=self.true)
        self.button_true.grid(row=2, column=0)
        self.button_false = Button(image=false_image, highlightthickness=0, command=self.false)
